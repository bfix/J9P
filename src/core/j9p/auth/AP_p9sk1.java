...
//******************************************************************
//*   PGMID.        P9SK1 AUTHENTICATION PROTOCOL HANDLER.         *
...
///////////////////////////////////////////////////////////////////////////////
/**
 *  <p>Implementation of the 'p9sk1' authentication protocol.</p>
 * 
 * @author Bernd R. Fix   >Y<
 * @version 1.0
 */
public class AP_p9sk1 extends AP_p9sk {
	...
	public static class Id extends AP_p9sk.Id {
		 ...
		 */
		public String getAuthProtocol()	{ return "p9sk1"; }
	}
